...
import { PHONE, WHATSAPP_LINK, CALL_LINK, EMAIL, ADDRESS, HOURS } from '../constants';
...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const msg = encodeURIComponent(
      `*Contact Form – Guru Rooster Farm*\n\nName: ${form.name}\nPhone: ${form.phone}\nEmail: ${form.email}\nSubject: ${form.subject}\nMessage: ${form.message}`
    );
    ...
    <div>
      ...
      <section className="hero-section relative overflow-hidden min-h-[280px] flex items-center">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1559715745-e1b33a271c8f?w=1200&h=400&fit=crop&q=80"
            alt="Contact"
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 py-12 grid md:grid-cols-2 items-center gap-8">
          ...
          <div className="hidden md:block">
            <img
              src="https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=600&h=380&fit=crop&q=85"
              alt="Rooster"
            ...
            <form onSubmit={handleSubmit} className="card p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  <span className="absolute left-3 top-3.5 text-gray-400"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></span>
                  <input type="text" placeholder={t('Your Name')} value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required className="input-field pl-9" />
                </div>
                <div className="relative">
                  <span className="absolute left-3 top-3.5 text-gray-400"><Phone size={15} /></span>
                  <input type="tel" placeholder={t('Phone Number')} value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} required className="input-field pl-9" />
                </div>
              </div>
              <div className="relative">
                <span className="absolute left-3 top-3.5 text-gray-400"><Mail size={15} /></span>
                <input type="email" placeholder={t('Email Address')} value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} className="input-field pl-9" />
              </div>
              <div className="relative">
                <span className="absolute left-3 top-3.5 text-gray-400">✏</span>
                <input type="text" placeholder={t('Subject')} value={form.subject} onChange={e => setForm({ ...form, subject: e.target.value })} className="input-field pl-9" />
              </div>
              <textarea
                rows={4}
              ...
              <button type="submit" className="btn-primary w-full justify-center py-3">
                <Send size={16} />
                {sent ? t('Message Sent via WhatsApp!') : t('Send Message')}
              </button>
        ...
        <div className="max-w-7xl mx-auto card overflow-hidden p-0">
          <div className="grid md:grid-cols-3">
            <div className="p-6 bg-cream flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-500 text-sm mb-4">
                  {t('We are located in Salem, Tamil Nadu.')}<br />
            ...
            <div className="md:col-span-2 h-64 md:h-72">
              <iframe
                title="Guru Rooster Farm Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62751.98!2d78.1143!3d11.6643!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf1c1e9b6c8d7%3A0x1234567890abcdef!2sSalem%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1680000000000"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
