        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16 md:h-18">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight">
              <div className="font-display font-bold text-primary text-lg leading-none">GURU</div>
              <div className="text-xs font-semibold text-gray-500 tracking-widest uppercase">Rooster Farm</div>
            </div>
          </Link>
