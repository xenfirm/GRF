...
import { PHONE, WHATSAPP_LINK, EMAIL, ADDRESS, CALL_LINK, NAV_LINKS } from '../constants';
  ...
  return (
    <footer className="bg-primary-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="font-display font-bold text-white text-base leading-none">GURU</div>
              <div className="text-xs font-semibold text-primary-200 tracking-widest uppercase">Rooster Farm</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-primary-700 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-200">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-primary-700 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-200">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-primary-700 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-200">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2 text-primary-200 text-sm">
              <MapPin size={14} className="shrink-0 mt-0.5" /> {t('Salem, Tamil Nadu, India')}
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-primary-700 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center text-primary-300 text-xs">
          {t('© 2024 Guru Rooster Farm. All Rights Reserved.')}
        </div>
      </div>
    </footer>
  );
