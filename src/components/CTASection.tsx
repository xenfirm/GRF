...
export default function CTASection({
  ...
  return (
    <section className="bg-cream py-8 px-4">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-card px-6 py-6 flex flex-col sm:flex-row items-center gap-4 justify-between">
